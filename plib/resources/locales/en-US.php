...
return [
    ...
    'accessTitle'           => 'Chat access',
    'accessHelp'            => 'The server listens on port 5080 of the host. By default it is reachable only from the machine\'s own network.',
    'accessUrlHint'         => 'Chat URL:',
    'accessFirewallHint'    => 'To expose it on the public Internet, open port 5080 in the firewall, or manually configure a reverse proxy on a Plesk domain with TLS.',
